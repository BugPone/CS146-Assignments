...
public class Spider {
	...
	// # of urls you want
	//31 because indexs start at 0 and having i = 30 looks nice
	private static final int SUCCESSES_NEEDED = 31;
	...
	public String[] search(String url, String searchWord) {
		while (this.pagesVisited.size() < MAX_PAGES_TO_SEARCH && breaker < MAX_PAGES_TO_SEARCH) {
			...
			if (success) {
				...
				successes++; //breaks loop if all 35 successes are found
		 ...
		 * number URLs you wanted (31) after the max attempts of searches (100-500)
